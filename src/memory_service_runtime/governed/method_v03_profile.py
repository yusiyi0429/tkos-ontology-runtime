...
SCHEMA_VERSION = "tkos.method-profile/0.3"
CONTRACT_SHA256 = "17f0896993ac91bf232aa8d60de618ccec9b61b1d81fa68f815414943574381d"


class ContractRef(BaseModel):
    model_config = ConfigDict(extra="forbid")
    contract_id: Literal["tkos.method"] = "tkos.method"
    revision: Literal["0.3"] = "0.3"
...
class Profile(method_profile.MethodProfileCore):
    ...
    revision: Literal["0.3.0"]
    display_name: Literal["Anchor and Agent intake 2026-09-15"]
...
def content():
    value = {**method_profile.content(), "profile_core_schema_version": SCHEMA_VERSION,
             "revision": "0.3.0", "display_name": "Anchor and Agent intake 2026-09-15",
