...
def main():
    ...
    assert first['applied'] == ['0021_method_foundation.sql','0022_workspace_scenes.sql',
        '0023_method_lifecycle_v02.sql','0024_method_v02_binding_gate.sql','0025_method_anchors_v03.sql']
    ...
    print('New isolated database migrated through 0025; replay applied no migrations.')
